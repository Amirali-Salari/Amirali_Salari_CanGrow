...
mysql -u admin -padmin -h 127.0.0.1 -P6032 --prompt 'ProxySQL Admin> ' -e"SELECT * FROM mysql_servers;"
mysql -u admin -padmin -h 127.0.0.1 -P6032 --prompt 'ProxySQL Admin> ' -e"UPDATE global_variables SET variable_value='monitor' WHERE variable_name='mysql-monitor_username';"
mysql -u admin -padmin -h 127.0.0.1 -P6032 --prompt 'ProxySQL Admin> ' -e"UPDATE global_variables SET variable_value='monitor' WHERE variable_name='mysql-monitor_password';"
...
mysql -u admin -padmin -h 127.0.0.1 -P6032 --prompt 'ProxySQL Admin> ' -e"INSERT INTO mysql_users(username,password,default_hostgroup) VALUES ('root','secret_root_password',1);"
mysql -u admin -padmin -h 127.0.0.1 -P6032 --prompt 'ProxySQL Admin> ' -e"INSERT INTO mysql_users(username,password,default_hostgroup) VALUES ('database_user','secret_password',1);"
